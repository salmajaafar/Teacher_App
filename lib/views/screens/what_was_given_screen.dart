...
import 'package:parent_app/controllers/what_was_given_controller.dart';
...
class WhatWasGivenScreen extends StatelessWidget {
  const WhatWasGivenScreen({super.key});

  @override
  Widget build(BuildContext context) {
    final c = Get.put(WhatWasGivenController());
            ...
            child: SingleChildScrollView(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      'EXPLANATION OF WHAT WAS GIVEN IN THE LESSON :',
                      style: TextStyle(
                        fontFamily: 'KiwiMaru',
                        fontSize: 11.sp,
                    ...
                    SizedBox(height: 8.h),
                    TextField(
                      controller: c.explanationCtrl,
                      maxLines: 8,
                      decoration: InputDecoration(
                        hintText:
                            'WRITE HERE AN EXPLANATION ABOUT THE LESSON AND THE POINTS COVERED....',
